...
public struct UMPClient: Sendable {
    ...
    public var requestConsentIfNeeded: @Sendable (Config) async throws -> ConsentStatus
    public var consentStatus:          @Sendable () async -> ConsentStatus = { .unknown }
...
extension UMPClient {
    ...
    ///
    /// All fields default to production-safe values (`UMPClient.Config()` is safe to ship).
...
public typealias UMPConsentStatus = UMPClient.ConsentStatus
public typealias UMPConfig = UMPClient.Config
